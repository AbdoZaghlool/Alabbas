...
<h1 class="page-title"> تعديل سلايد
    <small> تعديل سلايد </small>
</h1>
@endsection
...
<div class="row">
    ...
    <div class="col-md-8">
        ...
        {!! Form::model($slider,['action'=>['AdminController\SliderController@update'
        ,$slider->id],'method'=>'PUT', 'enctype' => 'multipart/form-data']) !!}
